...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Palanquin%20Dark:ital,wght@0,400;0,500;0,600;0,700&display=swap" />,
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Palanquin:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700&display=swap" />,
  ]);
   setPostBodyComponents([
    <script
        key="QAPI"
